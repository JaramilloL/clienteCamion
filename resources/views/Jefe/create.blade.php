...
<div class="bg-dark vh-100">
    <div class="container">
        ...
        <form class="row g-3 needs-validation text-white" novalidate method="post" action="{{ url('/jefe') }}" enctype="multipart/form-data">
            @csrf
            <div class="col-md-4 position-relative">
              <label for="validationTooltip01" class="form-label">Nombre</label>
              <input type="text" class="form-control" id="validationTooltip01" required name="nombre">
            ...
            <div class="col-md-4 position-relative">
              ...
              <input type="text" class="form-control" id="validationTooltip02"  required name="edad">
              <div class="valid-tooltip">
                Looks good!
              </div>
            </div>
            ...
            <div class="col-md-4 position-relative">
              ...
              <input type="tel" class="form-control" id="validationTooltip02"  required name="telefono">
              <div class="valid-tooltip">
                Looks good!
              </div>
            </div>
