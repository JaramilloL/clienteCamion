...
<form action="{{ url('/auxiliar') }}" method="post" class="row g-3 needs-validation text-white" enctype="multipart/form-data">
    @csrf
      ...
      <div class="col-md-4 position-relative">
        ...
        <input type="text" class="form-control" id="validationTooltip02"  name="sexo" required>
      <div class="valid-tooltip">
          Looks good!
        </div>
      </div>
      ...
      <div class="col-md-4 position-relative">
        ...
        <input type="text" class="form-control" id="validationTooltip02"  name="status" required>
            <div class="valid-tooltip">
            Looks good!
            </div>
      </div>
      ...
      <div class="col-md-4 position-relative">
        ...
        <input type="file" class="form-control" id="validationTooltip01"  name="foto">
        <div class="valid-tooltip">
          Looks good!
        </div>
      </div>
